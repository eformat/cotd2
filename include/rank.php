...
$_SESSION['trivias'] = array( 
    ...
    '<p>My name is Seidler and I am from Sydney. I do not go out any more at night since they implemented the lock out laws. <small>Like me and we can talk about Sydney property prices.</small></p>',
    ...
    '<p>My name is Ponsonby and I live in Auckland. I made a satellite launch vehicle using a ball of wool, 3 paper clips and some bees wax. <small>Like me and we can build a mud brick metropolis together.</small></p>',
